...
class Animalerie:
    ...
    def get_cat_number(self):
        return len([cat for cat in self.__animaux if isinstance(cat, Chat)])

    def get_dog_number(self):
        return len([dog for dog in self.__animaux if isinstance(dog, Chien)])

    def get_bird_number(self):
        return len([bird for bird in self.__animaux if isinstance(bird, Oiseau)])
    ...
    def showNumbers(self):
        ...
        print(f"cats : {self.get_cat_number()} dogs : {self.get_dog_number()} birds {self.get_bird_number()}")
